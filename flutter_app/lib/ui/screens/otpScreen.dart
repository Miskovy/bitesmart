import 'dart:async';
import 'package:bite_smart/ui/screens/resetScreen.dart';
      ...
      child: TextField(
        ...
        inputFormatters: [
          FilteringTextInputFormatter
              .digitsOnly, // بتمنع كتابة أي حاجة غير الأرقام
        ],
        maxLength: 1,
        ...
        onChanged: (value) {
          if (value.length == 1 && !last) {
            FocusScope.of(context).nextFocus(); // الانتقال للخانة التالية
          }
          if (value.isEmpty && !first) {
            FocusScope.of(
              context,
            ).previousFocus(); // الرجوع للخانة السابقة عند المسح
          }
        },
      ),
    );
